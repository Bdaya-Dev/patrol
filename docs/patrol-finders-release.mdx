---
title: New package - patrol_finders_plus
---

We're introducing [`patrol_finders_plus`] - a new package in Patrol framework! It was
...
We made a short tutorial on how to use `patrol_finders_plus` package separately in
