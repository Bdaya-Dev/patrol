...
import 'package:patrol_finders_plus/patrol_finders.dart' as finders;
import 'package:patrol_log_plus/patrol_log.dart';
import 'package:patrol_plus/src/binding.dart';
import 'package:patrol_plus/src/global_state.dart' as global_state;
import 'package:patrol_plus/src/native/native_automator_config.dart';
import 'package:patrol_plus/src/platform/contracts/contracts.dart';
import 'package:patrol_plus/src/platform/platform_automator.dart';
// Need Group to recreate test hierarchy.
// ignore: implementation_imports
import 'package:test_api/src/backend/group.dart';
// Need Test to recreate test hierarchy.
// ignore: implementation_imports
  ...
  testWidgets(
    ...
    (widgetTester) async {
      ...
      try {
        ...
        // starts clean. stopAbandonedScreenRecording() swallows every error --
        // including a dropped connection when the app itself crashed -- so it
        // cannot mask the test's own failure.
        await platformAutomator.action.maybe(
