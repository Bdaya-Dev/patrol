...
import 'package:patrol_plus/src/platform/android/android_automator_empty.dart'
    as empty_android_automator;
import 'package:patrol_plus/src/platform/android/android_automator_empty.dart'
    if (dart.library.io) 'package:patrol_plus/src/platform/android/android_automator_native.dart'
    as native_android_automator;
import 'package:patrol_plus/src/platform/contracts/contracts.dart';
import 'package:patrol_plus/src/platform/current.dart' as current_platform;
import 'package:patrol_plus/src/platform/desktop/desktop_automator.dart';
import 'package:patrol_plus/src/platform/ios/ios_automator.dart';
import 'package:patrol_plus/src/platform/ios/ios_automator_config.dart';
import 'package:patrol_plus/src/platform/ios/ios_automator_empty.dart'
    as empty_ios_automator;
import 'package:patrol_plus/src/platform/ios/ios_automator_empty.dart'
    if (dart.library.io) 'package:patrol_plus/src/platform/ios/ios_automator_native.dart'
    as native_ios_automator;
import 'package:patrol_plus/src/platform/selector.dart';
import 'package:patrol_plus/src/platform/web/web_automator.dart';
import 'package:patrol_plus/src/platform/web/web_automator_config.dart';
import 'package:patrol_plus/src/platform/web/web_automator_empty.dart'
    as empty_web_automator;
import 'package:patrol_plus/src/platform/web/web_automator_empty.dart'
    if (dart.library.js_interop) 'package:patrol_plus/src/platform/web/web_automator_native.dart'
