...
void main() {
  group('Version compatibility', () {
    ...
    test('current patrol_cli_plus version is listed in compatibility file', () {
      ...
      expect(
        ...
        isTrue,
        reason:
            'Current patrol_cli_plus version $currentCliVersion is not listed in compatibility file',
      );
    });
    ...
    group('patrol_cli_plus 4.7.0 / patrol 4.9.0 split', () {
      test('patrol_cli_plus 4.7.0 requires patrol 4.9.0 or newer', () {
        expect(
      ...
      test('patrol 4.9.0 requires patrol_cli_plus 4.7.0 or newer', () {
        expect(
    ...
    test('current patrol_cli_plus is compatible with listed patrol versions', () {
      final currentCliVersion = Version.parse(constants.version);
      ...
      expect(
        ...
        isNotEmpty,
        reason:
            'No compatible patrol versions found for current patrol_cli_plus $currentCliVersion',
      );
      ...
      for (final patrolVersion in compatiblePatrolVersions) {
        expect(
          ...
          isTrue,
          reason:
              'Current patrol_cli_plus $currentCliVersion is not compatible with patrol $patrolVersion',
        );
      }
    });
  });
