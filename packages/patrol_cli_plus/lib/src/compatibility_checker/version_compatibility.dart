...
/// Represents a mapping between patrol and patrol_cli_plus compatible versions
class VersionCompatibility {
  ...
  /// The minimum version of patrol_cli_plus that is compatible
  final Version patrolCliBottomRangeVersion;

  /// The maximum version of patrol_cli_plus that is compatible (null means no upper bound)
...
/// patrol_cli_plus, patrol, and min Flutter version
