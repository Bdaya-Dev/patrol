...
- docs/feature-guide/meta.json (cannot carry a comment — listed here)
...
- packages/patrol_devtools_extension_plus/analysis_options.yaml (notice in file)
...
- packages/patrol_finders_plus/analysis_options.yaml (notice in file)
- packages/patrol_finders_plus/example/README.md (notice in file)
- packages/patrol_finders_plus/example/analysis_options.yaml (notice in file)
...
- packages/patrol_plus/analysis_options.yaml (notice in file)
...
- packages/patrol_plus/android/src/main/kotlin/pl/leancode/patrol/Logger.kt (notice in file)
- packages/patrol_plus/android/src/main/kotlin/pl/leancode/patrol/contracts/AndroidAutomatorServer.kt (notice in file)
- packages/patrol_plus/android/src/main/kotlin/pl/leancode/patrol/contracts/Contracts.kt (notice in file)
- packages/patrol_plus/build.yaml (notice in file)
...
- packages/patrol_plus/darwin/patrol_plus/Sources/PatrolImpl/AutomatorServer/Contracts.swift (notice in file)
...
- packages/patrol_plus/example/analysis_options.yaml (notice in file)
...
- packages/patrol_plus/lib/src/platform/contracts/android_automator_client.dart (notice in file)
- packages/patrol_plus/lib/src/platform/contracts/contracts.dart (notice in file)
- packages/patrol_plus/lib/src/platform/contracts/contracts.g.dart (notice in file)
...
- packages/patrol_plus/lib/src/platform/web/web_selector.g.dart (notice in file)
